...
#### Software engineer, graduated in Computer Science, I seek a creative approach to problem solving for software engineering and architecture issues. Currently working on Front-end web development using Angular, ReactJS, and Back-end usinng NodeJS (NestJS), Java (Spring), AWS, Docker, also working on other projects with Flutter.
